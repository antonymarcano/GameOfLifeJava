...
public class Neighbourhood implements Neighbours, NeedsABoard {
    ...
    public Neighbourhood(LiveCell cell) { this.cell = cell; }
    public static NeedsABoard of(LiveCell cell) { return new Neighbourhood(cell); }
